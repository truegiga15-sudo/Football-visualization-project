...
The reusable UI foundation is documented in [`docs-design-system.md`](./docs-design-system.md). Design tokens live in `src/styles/tokens.css`, typed variant metadata lives in `src/design-system`, and primitives live in `src/components/ui`.
